...
class Message:
    ...
    def __init__(self, message_id, src, date, chat, text='', forward_from=None, forward_date=None,
...
class MessageDictDecoder:
    ...
    def decode(obj: dict) -> Message:
        ...
        if obj.get('reply_to_message', None):
            reply_to_message = MessageDictDecoder.decode(obj['reply_to_message'])
        else:
            reply_to_message = None
        ...
        return Message(message_id=int(obj['message_id']), src=User.UserDictDecoder.decode(obj['from']),
                       ...
                       forward_from=forward_from, forward_date=forward_date, reply_to_message=reply_to_message)
